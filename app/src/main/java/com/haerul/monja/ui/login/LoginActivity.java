...
import com.haerul.monja.databinding.ActivityLoginBinding;
...
public class LoginActivity extends BaseActivity<ActivityLoginBinding, LoginViewModel> implements LoginViewModel.LoginNavigator {
    ...
    public int getBindingVariable() {
        return com.haerul.monja.BR.viewModel;
    }
    ...
    private void loginProcess() {
        ...
        if (login()) {
            ...
            object.addProperty(Constants.USER_EMAIL, binding.username.getText().toString().trim());
    ...
    protected void onStart() {
        ...
        if (Util.getBooleanPreference(this, "password_save")) {
            ...
            binding.username.setText(Util.getStringPreference(this, Constants.USER_EMAIL));
